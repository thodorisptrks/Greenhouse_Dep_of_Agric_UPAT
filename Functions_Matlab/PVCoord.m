function GRH_const_points = GreenhouseCoord(numCU_wdwise,numCU_lnwise,grh_width,grh_length,gut_hght,r_slope)
...
if roof_side == "South"
    PV_points_x = [grh_width-PV_width*cosd(r_slope),
        GRH_const_points.x("Point 9"),
        grh_width-PV_width*cosd(r_slope),
        GRH_const_points.x("Point 9")];
