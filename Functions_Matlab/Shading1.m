function [camvas_greenhouse_south,camvas_greenhouse_north] = Shading1(yr,mth,d,hr,mnt,scd,timezone,l_loc,lat)

% ,greenhouse_north_shaded_surface,greenhouse_north_shaded_surface_perc
...
elseif ~isnan(x_sun) && ~isnan(y_sun) && ~isnan(z_sun)
    ...
    CU_north_bounds_2d = boundary(CU_north_array(1:4,1),CU_north_array(1:4,2)); %
